...
const (
	...
	// MetaTitleModel records which model wrote the titles in this index, so a
	// row generated by one model is identifiable after switching to another.
	MetaTitleModel = "title_model"
)
